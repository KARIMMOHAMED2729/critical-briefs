...
@Component({
  selector: 'app-qamos',
  standalone: false,
  templateUrl: './qamos.component.html',
  styleUrls: ['./qamos.component.css']
})
export class QamosComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.dataService.getData().subscribe(data => {
      this.books = data.filter((book: Book) => book.product_category.includes('قواميس'));
